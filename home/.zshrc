# Managed dotfiles tool paths (macOS and Ubuntu).
...
# Credential assignment omitted; inject it separately.

# Colima docker socket (used by coder server / terraform docker provider)
